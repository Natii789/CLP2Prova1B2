...
export default function Candidato(props) {
    ...
    const { candidato, onSelect } = props;
    const [curtidas, setCurtidas] = useState(candidato.curtidas);
    const [descurtidas, setDescurtidas] = useState(candidato.descurtidas);
    const [propostas, setMostrarProposta] = useState(candidato.propostas);
    ...
    const Proposta = () => {
        setMostrarProposta(propostas)
    };
    const Questionamento = () => {
        setQuestionamentos(questionamentos)
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button variant="primary" onClick={Descurtir}>
                ...
                <Button className="mt-1" variant="success" >
                    Registrar questionamento
                </Button>
                <Button className="mt-1" variant="success" onClick={Proposta}>
